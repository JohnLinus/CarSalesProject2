...
public class AuctionControllerTest {
    ...
    public void addAuctionTest() {
        ...
        assertEquals("create(Auction)", MockAuctionDao.getCalledMethod());
    }
    ...
    public void getAuctionTest() {
        ...
        assertEquals("get(Auction,1)", MockAuctionDao.getCalledMethod());
    }
    ...
    public void getAllTest() {
        ...
        assertEquals("getAll(Auction)", MockAuctionDao.getCalledMethod());
    }
    ...
    public void getAllAvaliableTest() {
        ...
        assertEquals("getAuctionBySold(false)", MockAuctionDao.getCalledMethod());
    }
    ...
    public void getAllSoldTest() {
        ...
        assertEquals("getAuctionBySold(true)", MockAuctionDao.getCalledMethod());
    }
    ...
    public void getByEndTimeTest() {
        ...
        assertEquals("getAuctionByEndTime(" + min + "," + max + ")", MockAuctionDao.getCalledMethod());
    }
    ...
    public void unwrapAuctionTest() {
        Bid[] bids = MockAuctionDao.getBids(11L, 12L);
        Car c = MockAuctionDao.getCar(13L);
...
//        assertEquals(b1, b2);
    ...
    public void legalBidTest() {
        ...
        Bidder b = MockAuctionDao.getBidder(2L);
        ac.add(a);
        ...
        Bid bid = MockAuctionDao.getCreatedBid();
...
class MockAuctionDao implements DaoFacade {
